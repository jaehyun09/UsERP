...
public class PdDAOImpl implements PdDAO {
	 ...
	 * // 최유성 - 기초등록 - 구매 거래처 목록
	 * 
	 * @Override public List<CompanyVO> pdCompanySelect() {
	 * 
	 * return
	 * sqlSession.selectList("com.project.UsERP.persistence.PdDAO.pdCompanySelect");
	 * }
	 */
	 ...
	 * // 최유성 - 기초등록 - 상품 목록
	 * 
	 * @Override public List<ProductVO> pdProductSelect() {
	 * 
	 * return
	 * sqlSession.selectList("com.project.UsERP.persistence.PdDAO.pdProductSelect");
	 * }
	 * 
	 * // 최유성 - 입고 내역
	 * 
	 * @Override public List<LogisticsStatementVO> pdStockInOrder() {
	 * 
	 * return
	 * sqlSession.selectList("com.project.UsERP.persistence.PdDAO.pdStockInOrder");
	 * }
	 */
