ssd<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<form action ="hrSalaryCheck" method="post" onsubmit="return confirmCheck2();">
		...
		<c:if test="${selectCnt == 1}">
			...
			<input class="btn btn-outline-info" type="button" value="확인" onclick="setSalEmpInfo('${emp_code}', '${vo.emp_name}', '${dep_name}', '${hr_code_name}', '${sal_basic}', '${sal_over}')">
		</c:if>
	</form>
	</div>
</body>
