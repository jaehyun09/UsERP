               ...
               <div class="card-body">
                  ...
                  <div class="row">
                   ...
                   <!--  <tr>
						<th>주소</th>
						<td class="input"
							style="padding-top: 4px; padding-bottom: 4px; border-bottom: none">
							<input type="text" name="addcode" id="sample6_postcode"
							placeholder="우편번호" size=8 style="padding: 3px"> <input
							type="button" onclick="addressSearch();" value="주소찾기">
						</td>
					<tr>
						<th></th>
						<td class="input"
							style="padding-top: 4px; padding-bottom: 4px; border-bottom: none">
							<input type="text" name="add1" id="sample6_address" size=45
							placeholder=" 주소">
					...
					<tr>
						...
						<td class="input"
							style="padding-top: 4px; padding-bottom: 4px; border-bottom: none">
							<input type="text" name="add2" id="sample6_address2"
							placeholder=" 상세주소" size=45 onchange="addinput();"> <input
