						...
						<div class="row">
							...
							<div class="col-xl-12">
								...
								<div id="example" class="mb-9">
									<h2 class="h4">
										판매 현황 <a class="anchorjs-link" href="#example"
									...
									<div class="mb-3">
										...
										<ul class="nav nav-v2 nav-primary d-block d-xl-flex"
											...
											<li class="nav-item border-bottom border-xl-bottom-0"><a
												...
												aria-controls="pills-result-1" aria-selected="true"> 판매 내역 </a></li>
											<li class="nav-item border-bottom border-xl-bottom-0"><a
												class="nav-link d-flex align-items-center py-2 px-3"
												id="pills-html-tab-1" data-toggle="pill"
												href="#pills-html-1" role="tab" aria-controls="pills-html-1"
												aria-selected="false"> 판매 입력 </a></li>
											<li class="nav-item border-bottom border-xl-bottom-0"><a
												class="nav-link d-flex align-items-center py-2 px-3"
												id="pills-html-tab-1" data-toggle="pill"
											...
											<li class="nav-item border-bottom border-xl-bottom-0"><a
												...
												aria-selected="false"> 수금 현황 </a></li>
										</ul>
										<!-- End Nav Classic -->
											...
											<div class="tab-pane fade p-4 show active"
			                                	...
			                                	<div class="input-group">
				                                    ...
				                                    <i class="gd-search icon-text icon-text-sm"></i>
				                                  	...
				                                  	<input class="form-control form-control-icon-text" placeholder="판매 내역 검색" type="text" >
				                                </div>
				                                <br>
				                                <!-- 검색창 끝 --> 
													...
													<table class="table" style="text-align:center">
														<thead>
															<tr>
																...
																<th class="font-weight-semi-bold border-top-0 py-2">출고예정일</th>
													...
													<table class="table" style="text-align:center">
														...
														<tr>
															<td align = "center" colspan = "6">
																...
																<input class = "btn btn-outline-dark" type = "button" value = "판매 등록">
													...
													<table class="table" style="text-align:center">
														...
														<tbody>
															...
															<tr>
																...
																<td class="py-3">2017-05-14</td>
																<td class="py-3">
																	<input type = "button" class = "btn-outline-dark" value = "출고 요청">
																</td>
																<td class="py-3">판매승인</td>
															</tr>
														</tbody>
