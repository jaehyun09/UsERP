						...
						<div class="row">
							...
							<div class="col-xl-12">
								...
								<div id="example" class="mb-9">
									<h2 class="h4">
										구매 승인 내역 <a class="anchorjs-link" href="#example"
									...
									<div class="mb-3">
										...
										<ul class="nav nav-v2 nav-primary d-block d-xl-flex"
											...
											<li class="nav-item border-bottom border-xl-bottom-0"><a
												...
												aria-controls="pills-result-1" aria-selected="true"> 전체 </a></li>
											<li class="nav-item border-bottom border-xl-bottom-0"><a
												class="nav-link d-flex align-items-center py-2 px-3"
												id="pills-html-tab-1" data-toggle="pill"
												href="#pills-html-1" role="tab" aria-controls="pills-html-1"
												aria-selected="false"> 대기 </a></li>
											<li class="nav-item border-bottom border-xl-bottom-0"><a
												class="nav-link d-flex align-items-center py-2 px-3"
												id="pills-html-tab-1" data-toggle="pill"
												href="#pills-html-2" role="tab" aria-controls="pills-html-2"
												aria-selected="false"> 입고중 </a></li>
											<li class="nav-item border-bottom border-xl-bottom-0"><a
												class="nav-link d-flex align-items-center py-2 px-3"
												id="pills-html-tab-1" data-toggle="pill"
												href="#pills-html-3" role="tab" aria-controls="pills-html-3"
												aria-selected="false"> 완료 </a></li>
										</ul>
										<!-- End Nav Classic -->
														...
														<div class="collapse multi-collapse"
															...
															<div class="bg-white p-4">
																...
																<table class="table table-bordered" style="text-align:center">
																	<tbody>
																		<tr>
																			<th align="center">품명</td>
																			<td align="center">소마탄</td>
																			<th align="center">구매처</td>
																			<td align="center">성용(주)</td>
																			<th align="center">담당자</td>
																			<td align="center">홍리나</td>
																		</tr>
																		<tr>
																			<th align="center">구매가</td>
																			<td align="center">200,000</td>
																			<th align="center">수량</td>
																			<td align="center">350</td>
																			<th align="center">외상매출</td>
																			<td align="center">해당없음</td>
																		</tr>
																		<tr>
																			<th align="center">등록일</td>
																			<td align="center">2017-08-15</td>
																			<th align="center">최근수정일</td>
																			<td align="center">2017-08-15</td>
																			<th align="center">입고예정일</td>
