                                       ...
                                       <table class="table  bg-white text-dark center ass2 table-striped">
                                          ...
                                          <tbody>
                                            <c:forEach var="vo" items="${buy}">
                                             <tr>
                                                <td class="py-3">${vo.buy_code}</td>
                                                   <td class="py-3">${vo.comp_code}</td>
                                                <td class="py-3">${vo.pro_code}</td>
                                                <td class="py-3">${vo.pro_code}</td>
                                                <td class="py-3">${vo.buy_count}</td>
                                                <td class="py-3">${vo.emp_code}</td>
                                                <td class="py-3"><fmt:formatDate pattern="yyyy-MM-dd" value="${vo.buy_reg_date}"/></td>
                                                <c:if test="${vo.buy_state == 0 }">
                                                   <td class="py-3">전표 승인 대기중</td>
                                                </c:if>
                                                <c:if test="${vo.buy_state == 1 }">
                                                   <td class="py-3">입고 대기중</td>
                                                </c:if>
                                                <c:if test="${vo.buy_state == 2 }">
                                                   <td class="py-3">입고 대기중</td>
                                                </c:if>
                                                <c:if test="${vo.buy_state == 3 }">
                                                   <td class="py-3">입고 완료</td>
                                                </c:if>
                                             </tr>
                                             </c:forEach>
                                          </tbody>
