																			...
																			<c:if test="${vo.accs_state == 1 }">
																				...
																				<tr>
																					...
																					<c:if test="${vo.accs_type == 1 }">
																						<td class="py-1 " style="vertical-align: middle">판매
																							전표</td>
																					</c:if>
																					<c:if test="${vo.accs_type == 3 }">
																						<td class="py-1 " style="vertical-align: middle">채권
																							전표</td>
																					</c:if>
																					...
																					<c:if test="${vo.accs_type == 4 }">
																						<td class="py-1 " style="vertical-align: middle">채무
																							전표</td>
																					</c:if>
																		...
																		<c:forEach var="vo" items="${statement}">
																			<c:if test="${vo.accs_state == 0 }">
																				<tr>
																					<td class="py-1 ">
																						<p>
																							<input type="hidden" id="accs_code"
																								value=${vo.accs_code }> <a class="btn"
																								data-toggle="collapse"
																								href="#multiCollapseExample2" role="button"
																								aria-expanded="false"
																								aria-controls="multiCollapseExample2"
																								onclick="content1()">${vo.accs_code}</a>
																						</p>
																					</td>
																					<c:if test="${vo.accs_type == 1 }">
																						<td class="py-1 " style="vertical-align: middle">판매
																					...
																					<td class="py-1 " style="vertical-align: middle"><fmt:formatDate
																							pattern="yyyy-MM-dd" value="${vo.accs_reg_date}" /></td>
																					<td class="py-1 " style="vertical-align: middle">대기중
																					</td>
																				</tr>
																			</c:if>
																		</c:forEach>
													...
													<div class="px-3 p-4">
														<ul id="tabs2"
															...
															<li class="nav-item"><a
																...
																data-toggle="tab">채무 조회 </a></li>
															<li class="nav-item ml-4"><a
																class="nav-link px-2 pb-2 ass2" href="#tabs2-tab6"
																role="tab" aria-selected="false" data-toggle="tab">채권
																	조회 </a></li>
														</ul>
														<div id="tabsContent2" class="card-body tab-content p-3">
																	...
																	<table
																		...
																		<tbody>
																			<c:forEach var="vo" items="${bondDebt}">
																				<c:if test="${vo.accs_type == 2 }">
																				<tr>
																				<td class="py-1" style="vertical-align: middle">${vo.accs_code}</td>
																						...
																						<td class="py-1" style="vertical-align: middle">
																							<p>
																								<a class="btn" data-toggle="collapse"
																									...
																									aria-expanded="false"
																									aria-controls="multiCollapseExample5">${vo.company.com_name}</a>
																							</p>
																						</td>
