				...
				<div class="card">
					<div class="card-body">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">내정보</a></li>
							...
							<div class="col-xl-12">
								<div id="example" class="mb-9">
									<h4 class="h1 text-dark"><b>
										내정보 수정 </b><a class="anchorjs-link" href="#example"
                     ...
                     <table class="table bg-white text-dark center ass2" style="text-align:center">
                        <tr>
                           <th class="text-white table-bordered tap py-3 con2"colspan="3"> 내정보 수정 </th>
                        </tr>
                        <tr>
